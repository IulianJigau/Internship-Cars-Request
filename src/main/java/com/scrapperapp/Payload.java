...
public class Payload {
    ...
    public void addFilters(Filter filter) {
        this.variables.input.filters.add(filter);
    }

    private class Variables {

        private boolean isWorkCategory = false;
        private boolean includeCarsFeatures = true;
        private boolean includeBody = false;
        private boolean includeOwner = true;
        private boolean includeBoost = false;
    ...
    private class Input {
        ...
        private int subCategoryId = 659;
        private String source = "AD_SOURCE_DESKTOP";
